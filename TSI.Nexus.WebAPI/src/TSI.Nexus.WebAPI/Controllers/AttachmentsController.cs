...
namespace TSI.Nexus.WebAPI.Controllers
{
    ...
    public class AttachmentsController : ControllerBase
    {
        ...
        [HttpGet("GetByPurchaseOrderId/{id}")]
        [Authorize]
        public async Task<
            ActionResult<
                WebApiResponse<System.Collections.Generic.IEnumerable<AttachmentResponseDto>>
            >
        > GetByPurchaseOrderId(Guid id)
        {
            return await _attachmentService.GetByPurchaseOrderId(id);
        }
        ...
        public async Task<
            ActionResult<
                WebApiResponse<System.Collections.Generic.IEnumerable<AttachmentResponseDto>>
            >
        > GetByVehicleId(Guid id)
        {
            return await _attachmentService.GetByVehicleId(id);
        }

        [HttpGet("GetByDriverId/{id}")]
        [Authorize]
        public async Task<
            ActionResult<
                WebApiResponse<System.Collections.Generic.IEnumerable<AttachmentResponseDto>>
            >
        > GetByDriverId(Guid id)
        {

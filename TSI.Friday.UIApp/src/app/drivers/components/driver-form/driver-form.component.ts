...
// Type-only: DriverDetailsModalComponent imports this form back (renders <app-driver-form> in
...
import type { DriverDetailsModalComponent } from '../driver-details-modal/driver-details-modal.component';

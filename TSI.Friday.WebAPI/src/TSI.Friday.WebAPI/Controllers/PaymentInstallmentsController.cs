...
namespace TSI.Friday.WebAPI.Controllers
{
    ...
    [ApiController]
    public class PaymentInstalmentsController : Controller
    {
        /// <summary>
        /// PaymentService object created to access the service model.
        /// </summary>
        private readonly IPaymentInstallmentService _paymentInstalmmentService;

        /// <summary>
        /// PaymentInstalmentsController constructor create to initialize the "_paymentInstalmmentService" using Dependency Injection.
        /// </summary>
        ...
        public PaymentInstalmentsController(IPaymentInstallmentService paymentService)
        {
            _paymentInstalmmentService = paymentService;
        }
        ...
        public async Task<IActionResult> Add([FromBody] PaymentInstallmentDto paymentDto)
        {
            ...
            var webApiResponse = await _paymentInstalmmentService.Add(paymentDto);
        ...
        public async Task<IActionResult> Update([FromBody] PaymentInstallmentDto paymentDto)
        {
            ...
            var webApiResponse = await _paymentInstalmmentService.Update(paymentDto);
            return Ok(webApiResponse);
        }
        ...
        {
            var webApiResponse = await _paymentInstalmmentService.Remove(paymentDto);
            return Ok(webApiResponse);
        }
        ...
        {
            var webApiResponse = await _paymentInstalmmentService.FindAll();
            return Ok(webApiResponse);
        }
        ...
        {
            var webApiResponse = await _paymentInstalmmentService.FindById(paymentId);
            return Ok(webApiResponse);
        }
        ...
        {
            var webApiResponse = await _paymentInstalmmentService.FindByPaymentId(paymentId);
            return Ok(webApiResponse);
        }
        ...
        [HttpGet]
        [Route("GetByClientId/{paymentId}")]
        public async Task<IActionResult> GetByClientId(int? clientId)
        {
            var webApiResponse = await _paymentInstalmmentService.FindByClientId(clientId);
            return Ok(webApiResponse);
        }
        ...
        {
            var webApiResponse = await _paymentInstalmmentService.FindByOrderId(orderId);
            return Ok(webApiResponse);
        }
    }
}
